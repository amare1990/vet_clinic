...
Postgres DBMS is used to create, modify and query SQL statements.
...
- **Create the required query sql statements over the many to many relationships**
...
`cd Your folder`
`git clone https://github.com/amare1990/vet_clinic.git`

Then refer the sql statements for creating, modifying and writing query statements.
